export default {
  ...
  answer: {
    "ping": ":ping_pong:\npongです！",
    "伴田|路子|みちこ|コロちゃん": ["ロコはロコです！", "ロコはロコです～！", "ロコはロコですー！", "ロコのファーストネームは、ロコなんですってば～！"],
    ...
    "アホ|あほ|阿呆|馬鹿|バカ|ばか|うんち|うんこ|ウンチ|ウンコ|クソ|くそ|糞|ボケ|ぼけ|カス|はげ|ハゲ|排泄|ゲロ|吐瀉物": ["ひどいです！", "ひどいですよ！プロデューサー！"],
